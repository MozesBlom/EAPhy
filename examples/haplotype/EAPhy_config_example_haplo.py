...
id_change_list = os.path.join(homePath,'examples', 'test_id_change_haplo.txt')               # Path to a tab-delim text file where every current ID has a corresponding new name (two columns, first column head: old_ID, second column head: new_ID), that is less than 10 characters long
